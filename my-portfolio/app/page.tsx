...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      {/* About Section */}
      <section id="about" className="bg-[#C3DBFD]/20 px-4 sm:px-6 lg:px-8 pt-48 pb-32">
      ...
      {/* Projects Section */}
      <section id="projects" className="px-4 sm:px-6 lg:px-8 py-32">
      ...
      {/* Contact Section */}
      <section id="contact" className="bg-[#C3DBFD]/20 px-4 sm:px-6 lg:px-8 py-32">
